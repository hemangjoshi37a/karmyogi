...
export const GRBL_SETTING_RICH: Record<number, GrblSettingRichMeta> = {
  ...
  // --- Extra axes A/B/C ($103–$105, $113–$115, $123–$125, $133–$135) ---
  // GRBL is 3-axis; FluidNC / grblHAL continue the $1NN axis pattern for the
  // 4th/5th/6th axis (often rotary). Same groups/ranges as their X/Y/Z peers.
  103: {
    group: 'steps',
    description: 'A axis resolution in steps per mm (or steps per degree for a rotary axis). Must be > 0.',
    descKey: 'motion.set.103.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  104: {
    group: 'steps',
    description: 'B axis resolution in steps per mm/degree. Must be > 0.',
    descKey: 'motion.set.104.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  105: {
    group: 'steps',
    description: 'C axis resolution in steps per mm/degree. Must be > 0.',
    descKey: 'motion.set.105.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  113: {
    group: 'maxrate',
    description: 'A axis maximum feed rate (mm/min, or deg/min for a rotary axis). Must be > 0.',
    descKey: 'motion.set.113.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  114: {
    group: 'maxrate',
    description: 'B axis maximum feed rate. Must be > 0.',
    descKey: 'motion.set.114.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  115: {
    group: 'maxrate',
    description: 'C axis maximum feed rate. Must be > 0.',
    descKey: 'motion.set.115.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  123: {
    group: 'accel',
    description: 'A axis acceleration (linear ramp). Must be > 0.',
    descKey: 'motion.set.123.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  124: {
    group: 'accel',
    description: 'B axis acceleration (linear ramp). Must be > 0.',
    descKey: 'motion.set.124.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  125: {
    group: 'accel',
    description: 'C axis acceleration (linear ramp). Must be > 0.',
    descKey: 'motion.set.125.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  133: {
    group: 'maxtravel',
    description: 'A axis usable travel for soft limits. Must be > 0 when $20=1.',
    descKey: 'motion.set.133.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  134: {
    group: 'maxtravel',
    description: 'B axis usable travel for soft limits. Must be > 0 when $20=1.',
    descKey: 'motion.set.134.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
  135: {
    group: 'maxtravel',
    description: 'C axis usable travel for soft limits. Must be > 0 when $20=1.',
    descKey: 'motion.set.135.desc',
    min: 1,
    max: 100000,
    mustBePositive: true,
  },
